...
-- Таблица классы персонажа
CREATE SEQUENCE L2_CLASS_SEQ;
CREATE TABLE L2_CLASS (
                         L2_ID BIGINT NOT NULL,
                         L2_NAME CHARACTER VARYING (255) NOT NULL,
                         L2_TYPE CHARACTER VARYING (50) NOT NULL,
                         L2_LEVEL NUMERIC(1) NOT NULL,
                         L2_RACE_ID BIGINT NOT NULL,
                         L2_PARENT_CLASS_ID BIGINT,
                         CONSTRAINT PK_CLASS PRIMARY KEY(L2_ID),
                         CONSTRAINT FK_CLASS_RACE FOREIGN KEY(L2_RACE_ID) REFERENCES L2_RACE(L2_ID),
                         CONSTRAINT FK_CLASS_PARENT FOREIGN KEY(L2_PARENT_CLASS_ID) REFERENCES L2_CLASS(L2_ID)
);
ALTER TABLE L2_CLASS ADD CONSTRAINT UK_CLASS UNIQUE(L2_NAME);